            ...
            <div class="software-container flex flex-col shrink-0 gap-5 w-[325px]">
                ...
                <div class="card-software w-full flex items-center bg-[#F4F5F8] rounded-2xl p-5 gap-4 transition-all duration-300 hover:ring-2 hover:ring-portto-purple">
                    <div class="w-[70px] h-[70px] bg-white rounded-full flex shrink-0 items-center justify-center">
                        <img src="{{ Storage::url($item->logo) }}" alt="tool">
                    </div>
                    <div class="flex flex-col gap-[2px]">
                        <p class="tool-title font-bold text-xl leading-[30px]">{{ $item->name}}</p>
                        <p class="text-lg text-[#878C9C]">{{ $item->tagline }}</p>
                    </div>
                </div>
                @empty
...
<section id="Screenshots" class="container max-w-[1130px] mx-auto pt-[50px]">
    <div class="flex flex-col gap-5">
        ...
        <div class="grid grid-cols-4 gap-5">
            ...
            <a href="{{ Storage::url($schrenshoot->$schrenshoot) }}" class="group w-full h-[190px] flex overflow-hidden rounded-[30px] ring-1 ring-[#E4E5E8] transition-all duration-300 hover:ring-[3px] hover:ring-portto-purple relative" data-fancybox="gallery" data-caption="Screenshot #1">
                <img src="{{ Storage::url($schrenshoot->$schrenshoot) }}" class="w-full h-full object-cover" alt="thumbnail">
